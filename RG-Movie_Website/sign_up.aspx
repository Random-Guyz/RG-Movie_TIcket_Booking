...
<body class="formBody">
    ...
    <form class="loginForm" autocomplete="off">
        ...
        <div class="control block-cube block-input">
            <input name="email" pass="uname" type="email" placeholder="Enter Your Email" autofocus required />
            <div class="bg-top">
                <div class="bg-inner"></div>
            </div>
            <div class="bg-right">
        ...
        <div class="control block-cube block-input">
            <input name="mob" pass="uname" type="number" placeholder="Enter Your Mobile Number" autofocus required />
            <div class="bg-top">
                <div class="bg-inner"></div>
            </div>
            <div class="bg-right">
        ...
        <div class="control block-cube block-input">
            <input name="username" pass="uname" type="text" placeholder="Enter Your Username" autofocus required />
            <div class="bg-top">
                <div class="bg-inner"></div>
            </div>
            <div class="bg-right">
        ...
        <div class="control block-cube block-input">
            <input name="CONpassword" id="Conpwd" type="password" placeholder="Conform Your Password" required />
            <div class="bg-top">
                <div class="bg-inner"></div>
            </div>
            <div class="bg-right">
        ...
        <div class="terms-text">
            <label for="termsCheckbox">I Read & Agree to the <a href="TermsModal.aspx">Terms and Conditions</a></label>
        </div>

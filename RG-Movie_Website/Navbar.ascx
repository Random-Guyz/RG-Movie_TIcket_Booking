    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form runat="server" class="d-flex">
                <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn btn-outline-secondary me-4" OnClick="LoginBtn_Click" />
                <asp:Button ID="Button2" runat="server" Text="Sign In" CssClass="btn btn-outline-secondary me-4" OnClick="SignInBtn_Click" />
            </form>
        </div>
    </div>
</nav>
